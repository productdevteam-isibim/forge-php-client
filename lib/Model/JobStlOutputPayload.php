...
/**
 * JobStlOutputPayload Class Doc Comment
 *
 * @category    Class
 * @package     Autodesk\Forge\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class JobStlOutputPayload implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'jobStlOutputPayload';
    ...
    protected static $swaggerTypes = [
        'type' => 'string',
        'advanced' => '\Autodesk\Forge\Client\Model\JobStlOutputPayloadAdvanced',
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'type', must be one of 'svf', 'svf2', 'thumbnail', 'stl', 'step', 'iges', 'obj'.";
        }
    ...
    /**
     * Gets advanced
     * @return \Autodesk\Forge\Client\Model\JobStlOutputPayloadAdvanced
     */
    ...
    /**
     * Sets advanced
     * @param \Autodesk\Forge\Client\Model\JobStlOutputPayloadAdvanced $advanced
     * @return $this
     */
